...
import { projectStrings } from '../res/strings';
            ...
            <div className="row" id="project">
                <div className="col-md-6">
                    ...
                    <div id="projectNavigation">
                        <div className="row">
                            <button type="button" className="col-xl-3 btn btn-outline-dark">Process Journal</button>
                            <p className="col-xl-9">See my monthly progress during the school year.</p>
                        </div>
                        <div className="row">
                            <button type="button" className="col-xl-3 btn btn-outline-dark">The Report</button>
                            <p className="col-xl-9">See the history behind my project and work to compose it.</p>
                        </div>
                        <div className="row">
                            <button type="button" className="col-xl-3 btn btn-outline-dark">Bibliography</button>
